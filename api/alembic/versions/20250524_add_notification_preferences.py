...
def upgrade() -> None:
    ...
    op.add_column('users',
        sa.Column('notification_preferences',
    ...
    op.add_column('users', sa.Column('email_unsubscribed', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('users', sa.Column('email_unsubscribed_at', sa.DateTime(), nullable=True))
    op.add_column('users', sa.Column('email_bounced', sa.Boolean(), nullable=False, server_default='false'))
