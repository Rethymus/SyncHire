...
def upgrade():
    ...
    op.create_index(
        "ix_search_history_search_timestamp", "search_history", ["search_timestamp"]
    )
    op.create_index(
        "ix_search_history_user_timestamp",
        "search_history",
        ["user_id", sa.text("search_timestamp DESC")],
        postgresql_using="btree",
    )
    op.create_index(
        "ix_search_history_user_type", "search_history", ["user_id", "search_type"]
    )
    ...
    op.create_index(
        "ix_saved_searches_user_favorite", "saved_searches", ["user_id", "is_favorite"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_search_analytics_user_term", "search_analytics", ["user_id", "search_term"]
    )
    op.create_index(
        "ix_search_analytics_user_frequency",
        "search_analytics",
        ["user_id", sa.text("search_count DESC")],
        postgresql_using="btree",
    )
