...
_STOP_WORDS = {
    "and", "or", "the", "a", "an", "to", "for", "of", "in", "with",
    "using", "we", "are", "is", "this", "that", "you", "your", "our",
    "will", "be", "as", "at", "on", "by", "it", "or", "if", "from",
    "about", "who", "what", "how", "their", "they", "has", "have",
    "not", "can", "us", "etc", "e", "g", "job", "work", "team", "role",
    "years", "year", "experience", "strong", "plus", "preferred",
    "required", "requirements", "responsibilities", "qualifications",
    "candidate", "candidates", "company", "ability", "including",
    "related", "field", "new", "well", "across", "within", "other",
}

# Weighted signal terms: matches here count more than generic overlap
_HIGH_VALUE_TERMS = {
    "python", "typescript", "javascript", "java", "golang", "rust",
    "react", "next.js", "vue", "angular", "svelte", "node", "node.js",
    "fastapi", "django", "flask", "spring", "sqlalchemy",
    "postgresql", "mysql", "sqlite", "redis", "mongodb",
    "docker", "kubernetes", "k8s", "aws", "gcp", "azure", "terraform",
    "linux", "git", "ci", "cd", "rest", "graphql", "grpc",
    "machine", "learning", "deep", "pytorch", "tensorflow",
    "llm", "nlp", "ai", "data", "analytics", "etl", "spark",
    "testing", "pytest", "jest", "vitest", "playwright",
    "security", "product", "design", "mobile", "android", "ios",
