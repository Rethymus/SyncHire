# SyncHire Documentation Index

This index keeps long-lived project documentation easy to find. Historical
delivery reports and one-off audit summaries are intentionally excluded from the
...
- [Internationalization Guide](./i18n-implementation-guide.md)
...
- [Database Performance Audit](./database-performance-audit-report.md)
- [CI/CD Best Practices](./CI_CD_BEST_PRACTICES_2026.md)
