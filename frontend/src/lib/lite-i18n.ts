...
export const LITE_COPY = {
  "en-US": {
    ...
    applications: {
      ...
      createDialog: {
        ...
        selectDescription: "Choose a resume and job description to create a new application.",
        confirmDescription: "Confirm your selections before creating the application.",
        missingTitle: "Missing Required Information",
        missingCreateMessage: "Please select both a resume and a job description to create an application.",
        missingContinueMessage: "Please select both a resume and a job description to continue.",
        missingActions: [
          "Choose a resume from your uploaded resumes",
          "Select a job description from your saved roles",
          "Upload a new resume or add a job description if needed",
        ],
        errorActionsTitle: "What you can do:",
        retry: "Retry",
        attempt: "Attempt {count} of 3",
        maxRetriesTitle: "Maximum Retries Exceeded",
        maxRetriesMessage: "Maximum retry attempts reached. Please try again later.",
        maxRetriesActions: [
          "Wait a few minutes before trying again",
          "Refresh the page and restart the process",
          "Check your local data before retrying",
        ],
        selectResume: "Select Resume *",
        resumePlaceholder: "Choose the resume to use",
        noResumePrefix: "Please",
        uploadResume: "upload a resume",
        selectJobDescription: "Select Job Description *",
        jdPlaceholder: "Choose the role to apply for",
        noJdPrefix: "Please",
        addJobDescription: "add a job description",
        notes: "Notes (optional)",
        notesPlaceholder: "Add notes for this application...",
        resumeUsed: "Resume used",
        targetRole: "Target role",
        at: "at",
        createHint: "After creation, SyncHire will analyze resume-to-role fit and suggest next actions.",
        cancel: "Cancel",
        continue: "Continue",
        back: "Back",
        creating: "Creating...",
  ...
  "zh-CN": {
    ...
    applications: {
      ...
      createDialog: {
        title: "创建职位申请",
        selectDescription: "选择简历和职位描述来创建新的职位申请。",
        confirmDescription: "确认你的选择并创建申请。",
        missingTitle: "缺少必要信息",
        missingCreateMessage: "请选择一份简历和一个职位描述后再创建申请。",
        missingContinueMessage: "请选择一份简历和一个职位描述后再继续。",
        missingActions: [
          "从已上传简历中选择一份",
          "从已保存职位描述中选择目标岗位",
          "如有需要，先上传新简历或添加职位描述",
        ],
        errorActionsTitle: "你可以这样排查：",
        retry: "重试",
        attempt: "第 {count} 次，共 3 次",
        maxRetriesTitle: "已达到最大重试次数",
        maxRetriesMessage: "已达到最大重试次数。请稍后再试。",
        maxRetriesActions: [
          "等待几分钟后再试",
          "刷新页面并重新开始创建流程",
          "重试前检查本地简历和职位描述数据",
        ...
        selectResume: "选择简历 *",
        resumePlaceholder: "选择要使用的简历",
        noResumePrefix: "请先",
        uploadResume: "上传简历",
        selectJobDescription: "选择职位描述 *",
        jdPlaceholder: "选择要申请的职位",
        noJdPrefix: "请先",
        addJobDescription: "添加职位描述",
        notes: "备注（可选）",
        notesPlaceholder: "添加关于此申请的备注...",
        resumeUsed: "使用的简历",
        targetRole: "申请职位",
        at: "于",
        createHint: "创建申请后，SyncHire 将分析你的简历与职位描述匹配度，并提供下一步建议。",
        cancel: "取消",
        continue: "继续",
        back: "返回",
        creating: "创建中...",
