...
function buildLocalMatchDetails(
  ...
  return {
    ...
    softSkillsScore: categoryScore("Soft Skills", 20, overallPercentage, "Lite 模式使用总分估算软技能匹配"),
    experienceScore: categoryScore("Experience", 25, overallPercentage, "Lite 模式使用简历经历与总分估算经验匹配"),
    educationScore: categoryScore("Education", 15, overallPercentage, "Lite 模式使用总分估算教育背景匹配"),
    skillMatches,
    missingSkills,
    ...
    recommendations,
    radarChartData: [
      { category: "Hard Skills", score: skillsPercentage, maxScore: 100 },
      { category: "Soft Skills", score: overallPercentage, maxScore: 100 },
      { category: "Experience", score: overallPercentage, maxScore: 100 },
      { category: "Education", score: overallPercentage, maxScore: 100 },
    ],
